...
<form-card title="Driver's Information">
  <div>
    <form-row>
      ...
      <jurisdiction-field :disabled=true id="drivers_licence_jurisdiction" :path="path"  fg_class="col-sm-3">Prov / State / International</jurisdiction-field>
    </form-row>
    <form-row>
    ...
    <form-row>
      <text-field id="address1" :path="path"  fg_class="col-sm-8" placeholder="Address" rules="required|max:25">Address</text-field>
